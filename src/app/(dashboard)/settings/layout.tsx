...
import { Radio, Users, Tags, Bell, Building2, KeyRound, Sparkles, BookUser, Palette, Brain, UserCircle, MessageSquare, Layers } from 'lucide-react';
...
const tabs = [
  ...
  { href: '/settings/quick-replies', label: 'Mensagens rápidas', icon: MessageSquare },
];
