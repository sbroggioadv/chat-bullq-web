...
import { Radio, Users, Tags, Bell, Building2, KeyRound, Sparkles, BookUser, Palette, Brain } from 'lucide-react';
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="mx-auto w-full max-w-4xl shrink-0 px-6 pt-6">
        ...
        <nav className="scrollbar-none mt-6 flex gap-1 overflow-x-auto border-b border-zinc-200 dark:border-zinc-800">
          {tabs.map((tab) => {
